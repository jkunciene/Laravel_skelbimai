                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e($ad->location); ?></td>
                                <td><a href="/ad_update/<?php echo e($ad->id); ?>" class="btn btn-danger">Koreguoti</a></td>
                                <td><a href="/ad_delete/<?php echo e($ad->id); ?>" class="btn btn-danger">Salinti</a></td>
                        </tr>
...
<?php echo $__env->make('skelbimai/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/skelbimai/resources/views/skelbimai/pages/ad_management.blade.php ENDPATH**/ ?>